# -*- coding: utf-8 -*-
"""
Created on Tue Feb 22 10:37:44 2022
...
class SegmenterProcess(multiprocessing.Process):
    ...
    def __init__(self, event, data_path):
        ...
        self.__img_path = "R:/3.Masters_projects/2021_Dominic_Rebindaine/new_cultures/img/"
    ...
    def _slice_image(self, img, name, mask, start_count=0):
        ...
        #minsizepix = 0 #You're welcome dom :)
    ...
    def segment_list(self, path_list: list, force=False, ecotaxa_export=True):
        ...
        if exception is None:
            ...
            print("HEHEHE bug..."+str(exception))
        # Reset process_id
        self.__process_id = ""
...
if __name__ == "__main__":
    ...
    segmenter_thread = SegmenterProcess(
            shutdown_event, "R:/3.Masters_projects/2021_Dominic_Rebindaine/new_cultures/pscope"
        )
